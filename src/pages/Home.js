...
function Home() {
  ...
  const secondMenuItems = [{ name: 'Overview' }, { name: 'Quickstart' }, { name: 'Guides' }, { name: 'Blog' }];
  ...
  const sixthMenuItems = [{ name: 'Overview' }, { name: 'Events' }, { name: 'Team' }];

  return (
    <div>
      <Header
        firstMenu={firstMenuItems}
        secondMenu={secondMenuItems}
        thirdMenu={thirdMenuItems}
        fourthMenu={fourthMenuItems}
        fifthMenu={fifthMenuItems}
        sixthMenu={sixthMenuItems}
      />
      <AboutSpring />
